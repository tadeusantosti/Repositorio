...
public class CompactCalendarTab extends Fragment {
    ...
    private void addEvents(int month, int year) {
        currentCalender.setTime(new Date());
        currentCalender.set(Calendar.DAY_OF_MONTH, 20);
    ...
    private List<Event> getEvents(long timeInMillis, int day) {
        if (day < 2) {
            return Arrays.asList(new Event(Color.BLUE, timeInMillis, "DRICO"));
        } else if (day > 2 && day <= 4) {
            return Arrays.asList(
                    new Event(Color.GREEN, timeInMillis, "TADEU "),
                    new Event(Color.GREEN, timeInMillis, "TADEU "));
        } else {
            return Arrays.asList(
                    new Event(Color.RED, timeInMillis, "CESAR"),
                    new Event(Color.RED, timeInMillis, "CESAR"),
                    new Event(Color.RED, timeInMillis, "CESAR"));
        }
    }
