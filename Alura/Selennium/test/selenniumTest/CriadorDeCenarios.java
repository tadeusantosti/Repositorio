...
public class CriadorDeCenarios {
    ...
    public CriadorDeCenarios umUsuario(String nome, String email) throws InterruptedException {
    ...
    public CriadorDeCenarios umLeilao(String usuario, String produto, double valor, boolean usado) throws InterruptedException {
